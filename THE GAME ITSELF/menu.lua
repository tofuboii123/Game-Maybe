...
function Menu:draw()
  ...
  elseif self.subMenu == 2 then
    ...
    if volumeState == 0 then
      ...
      love.graphics.setColor(1, 1, 1)
      love.graphics.print("Volume is at 100%", WINDOW_WIDTH/2 - 75, WINDOW_HEIGHT/2)
      love.graphics.setColor(0, 1, 0)
      love.graphics.rectangle("fill", WINDOW_WIDTH/2 - 40, WINDOW_HEIGHT/2 + 30, 10, 30)
      love.graphics.setColor(0, 1, 0)
      love.graphics.rectangle("fill", WINDOW_WIDTH/2 - 20, WINDOW_HEIGHT/2 + 30, 10, 30)
      love.graphics.setColor(0, 1, 0)
      love.graphics.rectangle("fill", WINDOW_WIDTH/2 , WINDOW_HEIGHT/2 + 30, 10, 30)
      love.graphics.setColor(0, 1, 0)
      love.graphics.rectangle("fill", WINDOW_WIDTH/2 + 20, WINDOW_HEIGHT/2 + 30, 10, 30)
      love.graphics.setColor(0, 1, 0)
      love.graphics.rectangle("fill", WINDOW_WIDTH/2 + 40, WINDOW_HEIGHT/2 + 30, 10, 30)
